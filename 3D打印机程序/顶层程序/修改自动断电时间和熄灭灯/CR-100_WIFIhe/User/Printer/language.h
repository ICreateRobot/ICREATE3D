...
/*Languages Choice 1:English 2:Polish 3:French 4:German 5:Spanish 6:Russian 7:Italian 8:Portuguese 9:Finnish*/
#define LANGUAGE_CHOICE 1

#define STARTUP_FIRMWARE_MESSAGE "Marlin Ver 1.70.1\n"
#define STARTUP_AUTHOR_MESSAGE "Last Updated: 2020-10-10 | Author: CR-100\n"
#define STARTUP_MACHINE_MESSAGE "MACHINE_TYPE: CR-100"

#define PROTOCOL_VERSION "1.2"
#define MACHINE_NAME "CR-100"
#define FIRMWARE_NAME "BiSun"
#define FIRMWARE_URL "https://www.cxsw3d.com"

#define SERIAL_ERROR_START "Error:"
#define SERIAL_ECHO_START "echo:"
...
// Serial Console Messages
  ...
  #define MSG_FILE_PRINTED "File Print Done\n"
  ...
  #define MSG_M115_REPORT "FIRMWARE_NAME:"FIRMWARE_NAME" FIRMWARE_URL:"FIRMWARE_URL" PROTOCOL_VERSION:"PROTOCOL_VERSION" MACHINE_TYPE:"MACHINE_NAME" EXTRUDER_COUNT:"STRINGIFY(EXTRUDERS)" UUID:NONE\n"
  ...
  #define MSG_WORKDIR_FAIL "workDir open failed"
  #define MSG_OPEN_FILE_FAIL "open failed, File: "
  #define MSG_FILE_OPENED "File opened: "
  #define MSG_FILE_SIZE " Size: "
  #define MSG_FILE_SELECTED "File selected"
  #define MSG_WRITE_TO_FILE "Writing to file: "
  #define MSG_FILE_PRINTING_BYTE "File printing byte "
  #define MSG_FILE_NOT_PRINTING "Not File printing"
  #define MSG_ERR_WRITE_TO_FILE "error writing to file"
  #define MSG_CANT_ENTER_SUBDIR "Cannot enter subdir: "
